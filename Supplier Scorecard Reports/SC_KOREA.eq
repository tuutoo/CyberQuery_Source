...
define
  string output_name = "D:\Supplier_Scorecards\New_Uploads\New_SC\SC_AP_KOR_"+ str((todaysdate-7),"YYYY_MMM");
...
where 
  prh_hist:prh_domain one of "KR001"
...
--#/csv="D:\Supplier_Scorecards\New_Uploads\New_SC\SC_Korea"
